...
def main():
    ...
    print(f"✅ Value range: [{tokenized_inflation.min():.1f}, {tokenized_inflation.max():.1f}]")
    ...
    print(f"✅ Value range: [{validation['statistics']['min']:.2f}, {validation['statistics']['max']:.2f}]")
